        ...
        <div class="grid grid-cols-1 grid-cols-3-md gap-4">
          <div class="card">
            <div class="card-content">
              ...
              <p class="font-medium">- Shwetank Maurya, Engineering Student</p>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-content">
              ...
              <p class="font-medium">- Shivam Yadav, Medical Student</p>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-content">
              ...
              <p class="font-medium">- Tanish Rathore, Business Major</p>
            </div>
          </div>
        </div>
      </section>
